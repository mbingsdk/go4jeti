...
func GetChannelVerify() *core8.ChannelServiceClient {
	...
	transport, err = thrift8.NewTHttpClient("https://gxx.line.naver.jp/CH4")
...
func Connect1() *core.TalkServiceClient {
	var err error
...
func multiOperations(last int64,count int32)(r []*core.Operation){
	client1 := Connect1()
